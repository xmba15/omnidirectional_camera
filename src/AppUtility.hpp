...
namespace
{
inline cv::viz::Viz3d initializeWindowWithCamera(cv::Affine3d& camPose, const cv::Matx33d& K, double scale = 0.1)
{
    cv::viz::Viz3d cameraWindow("demo");
    cv::Vec3d camPos(1.0, 0.0, 1.0), camFocalPoint(1.0, 0.0, 0.0), camUpVec(0.f, 1.0f, 0.0f);
